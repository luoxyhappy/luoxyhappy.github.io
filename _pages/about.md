...
<span style="font-size: 13px; color: #666;">GRID is an omni-visual generation framework that reformulates temporal tasks like video into grid layouts, enabling a single powerful image model to efficiently handle image, video, and 3D generation.</span>
...
<span style="font-size: 13px; color: #666;">A training-free method that uses isolated attention mechanisms to maintain character consistency and prevent feature confusion in story visualization.</span>
...
<span style="font-size: 14px;">**Xiangyang Luo**, Xin Zhang, Yifan Xie, Xinyi Tong, Weijiang Yu, Heng Chang, Fei Ma†, Fei Richard Yu</span><br>
