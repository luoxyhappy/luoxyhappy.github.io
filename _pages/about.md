...
I am currently a 2nd-year Master's student at [Tsinghua University](https://www.tsinghua.edu.cn/en/) <img src='./images/thu.png' style='width: 2em; vertical-align: middle;'>. I received my B.Eng. degree in Computer Science ([Yingcai Honors College](https://www.yingcai.uestc.edu.cn/en/index.htm)) from [University of Electronic Science and Technology of China](https://en.uestc.edu.cn/) <img src='./images/uestc.png' style='width: 2em; vertical-align: middle;'> in 2024.
...
<div style="display:flex;align-items:baseline;padding:0.35em 0.5em;border-bottom:1px solid #f0f0f0;"><span style="display:inline-block;min-width:88px;padding:0.15em 0.6em;background:#eef2f7;color:#4a6fa5;border-radius:4px;font-size:0.82em;font-weight:600;margin-right:1em;text-align:center;flex-shrink:0;">2025-07</span><span>Our Paper "<strong>Human Motion Video Generation: A Survey</strong>" is accepted by <code>TPAMI</code>.</span></div>
...
<a href="https://arxiv.org/abs/2603.25527" style="font-size: 15px; color: #483D8B; text-decoration: none"><strong>Beyond the Golden Data: Resolving the Motion-Vision Quality Dilemma via Timestep Selective Training</strong></a><br>
<span style="font-size: 13px;"><strong>Xiangyang Luo</strong>, Qingyu Li, Yuming Li, Guanbo Huang, Yongjie Zhu, Wenyu Qin, Meng Wang, Pengfei Wan, Shao-Lun Huang</span><br>
<span style="font-size: 13px;">[**Paper**](https://arxiv.org/abs/2603.25527)</span>

<span style="font-size: 12px; color: #666;">We identify the Motion-Vision Quality Dilemma in video data curation and propose Timestep-aware Quality Decoupling (TQD), which skews the training data sampling distribution across timesteps to decouple motion and visual quality, enabling models trained on imbalanced data to surpass those trained on golden data.</span>
...
<a href="{{ '/FilmWeaver/' | relative_url }}" style="font-size: 15px; color: #483D8B; text-decoration: none"><strong>FilmWeaver: Weaving Consistent Multi-Shot Videos with Cache-Guided Autoregressive Diffusion</strong></a><br>
<span style="font-size: 13px;"><strong>Xiangyang Luo</strong>, Qingyu Li, Xiaokun Liu, Wenyu Qin, Miao Yang, Meng Wang, Pengfei Wan, Di Zhang, Kun Gai, Shao-Lun Huang</span><br>
<span style="font-size: 13px;">[**Paper**]() [**Page**](https://filmweaver.github.io)</span>

<span style="font-size: 12px; color: #666;">FilmWeaver generates consistent multi-shot videos of arbitrary length via an autoregressive diffusion paradigm, enforcing inter-shot consistency with a Shot Cache and intra-shot coherence with a Temporal Cache, and supports applications such as concept injection and video extension.</span>
...
<span style="font-size: 13px;">Cong Wan\*, **Xiangyang Luo\***, Hao Luo, Zijian Cai, Yiren Song, Yunlong Zhao, Yifan Bai, Fan Wang, Yuhang He, Yihong Gong</span><br>
<span style="font-size: 13px;">[**Paper**](https://arxiv.org/pdf/2412.10718) [**Code**](https://github.com/Should-AI-Lab/GRID)</span>

<span style="font-size: 12px; color: #666;">GRID is an omni-visual generation framework that reformulates temporal tasks like video into grid layouts, enabling a single powerful image model to efficiently handle image, video, and 3D generation.</span>

</div>
</div>

<!-- ICME 2025 paper hidden for now
...
<a href="https://www.arxiv.org/pdf/2503.23353" style="font-size: 15px; color: #483D8B; text-decoration: none">**Object Isolated Attention for Consistent Story Visualization**</a><br>
<span style="font-size: 13px;">**Xiangyang Luo**, Junhao Cheng, Yifan Xie, Xin Zhang, Tao Feng, Zhou Liu, Fei Ma†, Fei Yu</span><br>
<span style="font-size: 13px;">[**Paper**](https://www.arxiv.org/pdf/2503.23353)</span>

<span style="font-size: 12px; color: #666;">A training-free method that uses isolated attention mechanisms to maintain character consistency and prevent feature confusion in story visualization.</span>
...
<a href="https://dl.acm.org/doi/10.1145/3664647.3681120" style="font-size: 15px; color: #483D8B; text-decoration: none">**CodeSwap: Symmetrically Face Swapping Based on Prior Codebook**</a><br>
<span style="font-size: 13px;">**Xiangyang Luo**, Xin Zhang, Yifan Xie, Xinyi Tong, Weijiang Yu, Heng Chang, Fei Ma†, Fei Richard Yu</span><br>
<span style="font-size: 13px;">[**Paper**](https://dl.acm.org/doi/10.1145/3664647.3681120)</span>

<span style="font-size: 12px; color: #666;">CodeSwap achieves high-fidelity face swapping by symmetrically manipulating codes within a pre-trained, high-quality facial codebook.</span>

</div>
</div>


<!-- Internships section hidden for now
# Internships
